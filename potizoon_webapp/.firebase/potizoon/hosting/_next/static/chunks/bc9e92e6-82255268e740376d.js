 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let f="10.12.1",g=new a.Yd("@firebase/firestore");function m(t,...e){if(g.logLevel<=a.in.DEBUG){let i=e.map(y);g.debug(`Firestore (${f}): ${t}`,...i)}}function E(t,...e){if(g.logLevel<=a.in.ERROR){let i=e.map(y);g.error(`Firestore (${f}): ${t}`,...i)}}function y(t){if("string"==typeof t)return t;try{/**
 * @license
